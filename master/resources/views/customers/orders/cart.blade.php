          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td>
                    <img class="shopping-product" src="{{ asset('eren') }}/images/cart-table1.jpg" alt="your product">
                  </td>
                ...
                <tr>
                  <td>
                    <img class="shopping-product" src="{{ asset('eren') }}/images/cart-table2.jpg" alt="your product">
                  </td>
                  <td class="product-name">
                      <h5>Name product #01</h5>
                  </td>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="shop_measures margintop40">
            ...
            <a href="{{ route('customers.orders.checkout') }}" class="uppercase btn-light border-radius margintop30">Proceed to checkout</a>
          </div>
        </div>
